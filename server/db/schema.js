...
function initSeedData() {
  ...
  const insertVersion = db.prepare(`
    INSERT INTO app_versions (app_name, version_no, vendor, status, submit_time, review_start_time, review_end_time, reject_count, shelf_status)
    VALUES (@app_name, @version_no, @vendor, @status, @submit_time, @review_start_time, @review_end_time, @reject_count, @shelf_status)
  `);

  const insertRecord = db.prepare(`
    INSERT INTO review_records (version_id, review_round, reviewer, start_time, end_time, result, reject_reason)
    VALUES (@version_id, @review_round, @reviewer, @start_time, @end_time, @result, @reject_reason)
  `);
